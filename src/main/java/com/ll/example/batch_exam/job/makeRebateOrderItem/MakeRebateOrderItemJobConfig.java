package com.ll.example.batch_exam.job.makeRebateOrderItem;

import com.ll.example.batch_exam.app.order.entity.OrderItem;
import com.ll.example.batch_exam.app.order.entity.RebateOrderItem;
import com.ll.example.batch_exam.app.order.repository.OrderItemRepository;
import com.ll.example.batch_exam.app.order.repository.RebateOrderItemRepository;
import com.ll.example.batch_exam.util.Util;
